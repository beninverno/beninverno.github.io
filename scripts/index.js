...
function main() {
    ...
    var musicArray = ["music/megaflora.mp3", "music/shootingstars.mp3", "music/zealots.mp3", "music/hollow.mp3", "music/shelter.mp3"];
    ...
    document.getElementById("music").onclick = function(){document.getElementById("audio").src = musicArray[musicNum];
                                                        ...
                                                        document.getElementById("music").onclick = null};
